...
def create_test_file():
    try:
        ...
        print('Error create_test_file()! Something wrong, but don\'t worry, be happy.'
              ' Maybe next time, buy yourself a ice cream :)')


def encoding_convert_file():
    try:
        ...
        print('Error encoding_convert_file()! Something wrong, but don\'t worry, be happy.'
              ' Maybe next time, buy yourself a ice cream :)')
        create_test_file()
...
def open_file():
    try:
        ...
        print('Error open_file()! Something wrong, but don\'t worry, be happy.'
                  ' Maybe next time, buy yourself a ice cream :)')
